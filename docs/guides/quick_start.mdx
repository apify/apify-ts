...
The CLI will prompt us to select a project boilerplate template - let's just pick `Crawlee cheerio template [TypeScript]`. The tool will create a directory called `my-cheerio-crawler` with a Node.js project files. We can run the project as follows:
