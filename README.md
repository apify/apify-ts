...
- [`CheerioCrawler`](https://apify.github.io/apify-ts/docs/api/cheerio-crawler) - Enables the parallel crawling of a large
...
- [`PuppeteerCrawler`](https://apify.github.io/apify-ts/docs/api/puppeteer-crawler) - Enables the parallel crawling of
...
- [`PlaywrightCrawler`](https://apify.github.io/apify-ts/docs/api/playwright-crawler) - Unlike `PuppeteerCrawler`
...
- [`BasicCrawler`](https://apify.github.io/apify-ts/docs/api/basic-crawler) - Provides a simple framework for the parallel
...
- [`RequestList`](https://apify.github.io/apify-ts/docs/api/request-list) - Represents a list of URLs to crawl.
...
- [`RequestQueue`](https://apify.github.io/apify-ts/docs/api/request-queue) - Represents a queue of URLs to crawl,
...
- [`Dataset`](https://apify.github.io/apify-ts/docs/api/dataset) - Provides a store for structured data and enables their export
...
- [`KeyValueStore`](https://apify.github.io/apify-ts/docs/api/key-value-store) - A simple key-value store for arbitrary data
...
- [`AutoscaledPool`](https://apify.github.io/apify-ts/docs/api/autoscaled-pool) - Runs asynchronous background tasks,
...
- [`Browser Utils`](https://apify.github.io/apify-ts/docs/api/puppeteer) - Provides several helper functions useful
